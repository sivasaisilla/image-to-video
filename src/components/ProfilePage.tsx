            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-3 gap-6 mt-6">
                  ...
                  <div className="text-center">
                    <div className="text-2xl mb-1">89h</div>
              ...
              <div className="backdrop-blur-md bg-white/5 border border-white/20 rounded-md p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-white text-sm mb-1">Created "Modern Villa Tour"</div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-white text-sm mb-1">Uploaded 24 photos</div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-white text-sm mb-1">Upgraded to Professional</div>
