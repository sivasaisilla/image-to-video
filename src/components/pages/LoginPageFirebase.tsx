...
export function LoginPageFirebase({ onBack, onSwitchToRegister, onLoginSuccess }: LoginPageProps) {
  ...
  const handleAppleSignIn = async () => {
    ...
    try {
      ...
      if (result.success) {
        setSuccess("Apple sign-in successful! Redirecting...");
        setTimeout(() => {
          onLoginSuccess();
        }, 1500);
      } else {
      ...
      <div className="w-full max-w-md">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Sign in to your IMOB Motion account</p>
          </div>
